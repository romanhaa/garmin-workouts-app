...
class CooldownView extends Ui.View {
    ...
    hidden var EXERCISES = [
        ...
        Ui.loadResource(Rez.Strings.exercise14),
        Ui.loadResource(Rez.Strings.exercise15),
        Ui.loadResource(Rez.Strings.exercise16)
    ];
    ...
    hidden var maxExerciseCount = 16;
    // Exercise delay
